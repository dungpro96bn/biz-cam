...
<h1 class="title">COLUMN<span>コラム</span></h1>
</section>
...
<li class="clearfix">
<figure class="thumbnail"><a href="<?php the_permalink(); ?>">
<?php
...
?>
<img src="<?php echo $thumb; ?>" alt="<?php the_title(); ?>のイメージ "></a>
</figure>
<?php
...
?>
<figure class="thumbnail"><a href="<?php echo get_term_link($term->slug, 'column-cat'); ?>"><img src="<?php echo $thumb_cat; ?>" alt="<?php echo $term->name; ?>のイメージ"></a></figure>
